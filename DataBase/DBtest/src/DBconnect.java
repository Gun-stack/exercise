...
public class DBconnect {
	...
	public static Connection getConnection() {
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:mariadb://localhost:3306/testdb","kosta", "1234");
	...
	public static void UpadateUserName(String id, String name) {
		Connection conn = getConnection();
		Statement stmt = null;
