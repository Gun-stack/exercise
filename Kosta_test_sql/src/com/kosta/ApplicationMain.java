...
public class ApplicationMain {
	...
	public static void main(String[] args) {
		...
		/*
		 * 주의 사항 1. 실행결과는 아래와 동일하게 출력되어야 한다. 2. 제공파일 ApplicationMain.java 파일은 절대 수정하면
		 * 안되며, 수정없이 실행하여 아래와 동일하게 출력되어야 한다. 3. Order.java, Product.java 파일은 생성자 구현과
		 * toString() 메서드만 Overriding 해야 하며, 일체의 수정이나 멤버변수, 멤버메서드 등을 추가하면 안된다. 4.
		 * Shop.java 파일은 ApplicationMain.java실행 시 아래와 동일하게 출력되도록 구현한다.
		 * 
		 * **** 아래(실행결과) **** 
		 ...
		 *  전체 주문 정보
		 * 출력 시작------------ 
		 * 주문 정보: 주문번호-1, 주문고객명-홍길동, 주문상품-P-1, 주문수량-2, 취소여부-정상 주문 정보:
		 * 주문번호-2, 주문고객명-홍길동, 주문상품-P-3, 주문수량-10, 취소여부-정상 주문 정보: 주문번호-3, 주문고객명-홍길동,
		 * 주문상품-P-3, 주문수량-5, 취소여부-정상 ------------전체 주문 정보 출력 종료------------ 주문 정보:
		 * 주문번호-3, 주문고객명-홍길동, 주문상품-P-3, 주문수량-5, 취소여부-정상 주문 정보: 주문번호-3, 주문고객명-홍길동,
		 * 주문상품-P-3, 주문수량-5, 취소여부-취소 홍길동님의 정상주문 건수는: 2건이고,정상주문합계금액은: 59000원 입니다. 홍길동님의
		 * 취소주문 건수는: 1건이고,취소주문합계금액은: 14500원 입니다.
		 * 
		 */
	}
}
